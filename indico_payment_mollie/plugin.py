...
from indico_payment_mollie.forms import EventSettingsForm, PluginSettingsForm


class MolliePaymentPlugin(PaymentPluginMixin, IndicoPlugin):
    """Mollie payments

    Provides a payment method using the Mollie payments API.
    """
    ...
    default_settings = {
        'method_name': 'Mollie payments',
        #'url': 'https://www.molllie.com/api/',
        #'username': None,
        #'password': None,
        #'account_id': None,
        'apikey': None,
        ...
        'notification_mail': 'evert.rol@gmail.com'
    }
    ...
    def get_blueprints(self):
        ...
        from indico_payment_mollie.blueprint import blueprint
        return blueprint
